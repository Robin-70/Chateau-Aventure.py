...
while True:
    ...
    if lieu == "jardin":
        pygame.mixer.music.load("624676__klankbeeld__birds-floodplains-1147am-210702_0300.wav")
        ...
        while lieu == "jardin":
            ...
            if action == "examiner":
                ...
                print("Vous n'oseriez pas brûler les rosiers royaux.\n")
            elif action == "sortie":
                print("Les sorties sont:\nest\nouest\nentrer hutte\n")
            elif action == ("est"):
                lieu = "étang"
            ...
            if action == "examiner":
                ...
                if canne_a_peche == 1:
                    if poisson == 0:
                        ...
                        poisson = 1
                        description["poisson"] = "Un poisson fraîchement pêché, cru. Il s'appelle probablement Steve.\n"
                    elif poisson == 1:
    ...
    if lieu == "sentier":
        pygame.mixer.music.load("701346__klankbeeld__wind-spring-12.wav")
        pygame.mixer.music.play(-1)
    ...
    if lieu =="cime_arbre":
        pygame.mixer.music.load("207373__klankbeeld__wind-trees-130914_02.wav")
        pygame.mixer.music.play(-1)
        if branche == 0:
    ...
    if lieu == "pont_levis":
        ...
        while lieu == "pont_levis":
            if poisson_troll == 0:
                pygame.mixer.music.load("316332__littlerobotsoundfactory__orc_22.wav")
                start()
            action = input()
            if action == "examiner":
                if poisson_troll == 1:
                ...
                print("Le troll est très grand, vert, fort et semble bougon.\n")
                ...
                if poisson == 1:
                    ...
                    poisson = 0
                    stop()
                    pygame.mixer.music.load("316321__littlerobotsoundfactory__orc_09.wav")
                    start()
                else:
        ...
        while lieu == "cour":
            ...
            if action == "examiner":
                ...
                if branche == 1:
                    ...
                    pygame.mixer.music.load("417539__theuncertainman__warrior-death-cry-british-male.wav")
                    start()
                else:
                ...
                if couronne_tête == 0:
                    ...
                    pygame.mixer.music.load("402021__theuncertainman__no-british-male.wav")
                    start()
    ...
    if lieu == "escalier_bas":
        ...
        while lieu == "escalier_bas":
            if fantome == 1:
                pygame.mixer.music.load("169323__klankbeeld__horror-ghost-01.wav")
                pygame.mixer.music.play(-1)  
            action = input()
            if action == "examiner":
    ...
    if lieu == "catacombe":
        ...
        while lieu == "catacombe":
            if fantome == 1:
                pygame.mixer.music.load("193686__toam__ghost_whispering01c-stereo.wav")
                pygame.mixer.music.play(-1)  
            action = input()
            if action == "examiner":
                if fantome == 1:
    ...
    if lieu == "salle_trone":
        print("C'est la salle du trône de Château Aventure !\nIl y a un trône d'or richement orné.\n")
        while lieu == "salle_trone":
            action = input()
            if action =="examiner":
                print("C'est la salle du trône de Château Aventure !\nIl y a un trône d'or richement orné.\n")
            elif action in ("asseoir sur trône", "s'asseoir sur trône", "asseoir sur trone", "s'asseoir sur trone"):
                if couronne_tête == 0:
                    print("Vous n'oseriez pas vous asseoir sur ce magnifique trône !\n")
                if couronne_tête == 1:
                    pygame.mixer.music.load("572935__gertraut_hecher__medieval-fanfare.wav")
                    start()
